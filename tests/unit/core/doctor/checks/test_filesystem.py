...
class TestNoSandboxRunning:
    def test_true_when_zero_projects(self, monkeypatch: Any) -> None:
        ...
        assert _no_sandbox_running("sandbox", DockerExecutionMode.SEPARATE_USER) is True
    ...
    def test_false_when_projects_present(self, monkeypatch: Any) -> None:
        ...
        assert _no_sandbox_running("sandbox", DockerExecutionMode.SEPARATE_USER) is False
