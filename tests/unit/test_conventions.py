...
_DOCKER_USER_READ_ALLOWLIST: dict[str, frozenset[str]] = {
    ...
    # LITERAL reads of the dedicated user, NOT operator-rootless owner-resolution
    # reads (the carrier config can default to op-rootless under direct unit-test
    # construction, where the resolver would wrongly return ``getpass.getuser()``).
