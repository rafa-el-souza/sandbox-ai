<!--
Verbatim reproduction of the Apache Software Foundation Software Grant and
Corporate Contributor License Agreement ("Agreement"), version r190612.

Source: https://www.apache.org/licenses/cla-corporate.pdf
The legal text below is reproduced unchanged from the official ASF document.

sandbox-ai uses this CCLA, collected via CLA Assistant (see CONTRIBUTING.md), for
contributions made on behalf of a corporation. References to "The Apache Software
Foundation" / "the Foundation" are the verbatim text of the agreement; for
sandbox-ai the receiving party is the project maintainer (zerotrust-ai), per the
...
Please use a pdf form filler, attach a signature, and email the
completed pdf file of this Agreement to secretary@apache.org.
