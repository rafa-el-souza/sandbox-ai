<!--
Verbatim reproduction of the Apache Software Foundation Individual Contributor
License Agreement ("Agreement") V2.2.

Source: https://www.apache.org/licenses/icla.pdf
The legal text below is reproduced unchanged from the official ASF document. The
governing privacy policy is at https://s.apache.org/cla-privacy-policy.

sandbox-ai uses this ICLA, collected via CLA Assistant (see CONTRIBUTING.md), to
preserve dual-licensing optionality. References to "The Apache Software
